...
import edu.stevens.cs522.chatapp.separatedprocess.Databases.DatabaseHelper;

public class ChatDbProvider extends ContentProvider {
    public static final String AUTHORITY = "edu.stevens.cs522.chatapp.separatedprocess";
