package edu.stevens.cs522.chatapp.separatedprocess.Providers;
...
public class QueryBuilder<T> implements LoaderManager.LoaderCallbacks<Cursor> {
    public static final String PROJECTION = "edu.stevens.cs522.chatapp.separatedprocess.PROJECTION";
    public static final String SELECTION = "edu.stevens.cs522.chatapp.separatedprocess.SELECTION";
    public static final String SELECTIONARGS = "edu.stevens.cs522.chatapp.separatedprocess.SELECTIONARGS";
